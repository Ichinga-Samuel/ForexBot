...
from aiomql import Symbol, Trader, Candles, Strategy, TimeFrame, OrderType, Sessions
        ...
        async with self.sessions as sess:
            while True:
                ...
                try:
                    ...
                    await self.trader.place_trade(order_type=self.entry.order_type, params=self.parameters)
                    await self.sleep(self.entry.snooze)
