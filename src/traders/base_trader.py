...
class BaseTrader(Trader):
    ...
    def save_profit(self, result: OrderSendResult, profit):
        try:
            ...
            profit = {'current_profit': profit, 'trail_start': 0.25, 'trail': 0.30, 'trailing': False,
                      'extend_start': 0.8} | self.trail_profits
            loss = {'trail_start': 0.8, 'hedge_point': -3} | self.trail_loss
