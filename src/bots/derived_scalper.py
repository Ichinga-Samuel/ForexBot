...
from ..strategies import ADXScalper, ADXScalper2, FFATR, ADXATR
...
def build_bot():
    ...
    ff_sts = [ST(symbol=ForexSymbol(name=sym)) for sym in syms for ST in [ADXScalper, ADXScalper2, FFATR]]
