...
from ..strategies import FingerFractal, FMomentum, HAFF, NFF, FingerADX, FingerTrap, RA
...
def build_bot():
    ...
    ff_sts = [ST(symbol=ForexSymbol(name=sym)) for sym in syms for ST in [FingerADX, RA]]
