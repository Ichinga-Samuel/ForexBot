...
def build_bot():
    conf = Config(config_dir='configs', filename='deriv_demo_1.json', reload=True, records_dir='records/deriv1/',
                  use_telegram=True, trailing_stops=True, exit_signals=True, trailing_loss=True, trail_start=0.55,
                  use_full=True, use_ram=True, shift_profit=0.2, sl_trail_start=0.20)
