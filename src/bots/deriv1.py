...
def build_bot():
    Config(config_dir='configs', filename='deriv_demo_1.json', reload=True, records_dir='records/deriv1/',
           trailing_stops=True, exit_signals=True, trailing_loss=True, use_ram=True, hedging=True, fixed_closer=True)
    ...
    ff_sts = [St(symbol=sym) for sym in ff_syms for St in [RMomentum, NMomentum, Momentum]]
