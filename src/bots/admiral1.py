...
from ..strategies import FingerFractal, FingerTrap, Momentum, RMomentum, NMomentum, FMomentum
...
def build_bot():
    ...
    sts = [St(symbol=sym, sessions=Sessions(intl)) for sym in syms for St in [Momentum, RMomentum, FMomentum]]
