...
from ..strategies import FingerFractal, FingerTrap, PostNut, Momentum
...
def build_bot():
    ...
    ff_sts = [St(symbol=sym) for sym in ff_syms for St in [FingerFractal, FingerTrap, PostNut, Momentum]]
