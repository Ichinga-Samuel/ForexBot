...
from ..strategies import FingerFractal, ADXCrossing, ADXATR
...
def build_bot():
    ...
    ff_sts = [ST(symbol=ForexSymbol(name=sym)) for sym in syms for ST in [FingerFractal, ADXCrossing, ADXATR]]
