...
class NMomentum(Strategy):
    ...
    def __init__(self, *, symbol: Symbol, params: dict | None = None, trader: Trader = None, sessions: Sessions = None,
        ...
        self.trader = trader or PTrader(symbol=self.symbol, ram=RAM(risk_to_reward=2),
    ...
    async def confirm_trend(self):
        try:
            ...
            candles.ta.sma(close='rsi', length=self.sma_length, append=True)
            ...
            if self.tracker.bullish and current.rxs:
            ...
            elif self.tracker.bearish and current.rxbs:
