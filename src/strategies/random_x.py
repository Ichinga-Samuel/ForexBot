...
class Chaos(Strategy):
    ...
    parameters = {"first_ema": 8, "second_ema": 13, "third_ema": 34, "ttf": TimeFrame.H1, "tcc": 720, "price_sma": 50,
                  "adx_cutoff": 22, "ltf": TimeFrame.M5, "etf": TimeFrame.M30, "tptf": TimeFrame.H1, "tpcc": 720,
                  "exit_timeframe": TimeFrame.M30, "exit_adx": 14, "excc": 720, 'exit_function': adx_closer}

    def __init__(self, *, symbol: Symbol, params: dict | None = None, trader: Trader = None, sessions: Sessions = None,
                 name: str = 'Chaos'):
        super().__init__(symbol=symbol, params=params, sessions=sessions, name=name)
        ram = RAM(risk_to_reward=3, risk=0.1)
        self.trader = trader or SPTrader(symbol=self.symbol, ram=ram, hedge_order=True, track_loss=False,
